...
testY=data[data['Country']==country][test_dates[(lookback):]].values[0]
...
trainY=data[data['Country']==country][train_dates[(lookback):]].values[0]
...
plt.scatter(train_dates[:-(lookahead)],trainY)
plt.scatter(train_dates[:-(lookahead)],trainPredict)
...
plt.scatter(test_dates[(lookback):],testY)
plt.scatter(test_dates[(lookback):],testPredict)
